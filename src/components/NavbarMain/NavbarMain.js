...
import { FaAngleDown, FaBible, FaBookOpen, FaBook, FaMusic } from "react-icons/fa"; // Import the icons
      ...
      >
        <Container>
          <Navbar.Brand href="/" className={styles.logo}>
            <img src={logo} alt="afm logo" style={{ width: '140px', height: 'auto', marginRight: '8px' }} />
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav style={{ marginLeft: "auto", display: "flex", alignItems: "center" }}>
              ...
              >
                <NavDropdown.Item as={NavLink} to="https://www.biblegateway.com/versions/King-James-Version-KJV-Bible/#booklist">
                  <FaBible /> Bible
                </NavDropdown.Item>
                <NavDropdown.Item as={NavLink} to="https://sdahymnals.com/Hymnal/">
                  <FaMusic /> Hymn
                </NavDropdown.Item>
                <NavDropdown.Item as={NavLink} to="https://m.egwwritings.org/">
                  <FaBookOpen /> EGW Writings
                </NavDropdown.Item>
              </NavDropdown>
            </Nav>
          </Navbar.Collapse>
